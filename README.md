...
============================================================
  ...
  Per-CWE breakdown:
    ...
    CWE-79                P=100%  R=75%  F1=86%  (TP=3 FP=0 FN=1)
    CWE-89                P=100%  R=67%  F1=80%  (TP=2 FP=0 FN=1)
```

> Results may vary based on the LLM used, this result is from `Qwen3.6 35b-a3b`.
